...
| [this-as-value.md](this-as-value.md) | `return this;` — `this` as a value: fluent chaining, the base-typed and interface-typed return, the interface default body, and the reference count that needs no new machinery. **Designed, not built** (D87's owed redesign, measured) |
