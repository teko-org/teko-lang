...
| a minimum `mc` a package declares (`[package].mc`) | landed on mc's side: `mc.toml` declares `mc = "0.17.2"`, a bare minimum that follows the pin (D64, D72 and its amendment) |
