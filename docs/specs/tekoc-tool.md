...
(D72; the pin has since moved on under the same frozen surface — `MC_VERSION` names it — and
`[package].mc` names 0.17.0 as the minimum, D72's second amendment; the measurements stand as taken),
