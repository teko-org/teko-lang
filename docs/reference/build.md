...
inside it. `mc build` stages it next to the `[compiler]` product — `build/lib/mc/v1.0.1/`
...
compiler and mc 1.0.1's library tree was not found`). A release archive therefore ships
