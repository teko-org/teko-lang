...
inside it. `mc build` stages it next to the `[compiler]` product — `build/lib/mc/v0.17.2/`
...
compiler and mc 0.17.2's library tree was not found`). A release archive therefore ships
