...
inside it. `mc build` stages it next to the `[compiler]` product — `build/lib/mc/v0.17.5/`
...
compiler and mc 0.17.5's library tree was not found`). A release archive therefore ships
