...
inside it. `mc build` stages it next to the `[compiler]` product — `build/lib/mc/v1.0.0/`
...
compiler and mc 1.0.0's library tree was not found`). A release archive therefore ships
