...
**O compilador antigo (`src/`) saiu no passo 1 do rebase (2026-09-06); toda menção a `src/` neste
documento é histórica.** Todo trabalho vive na raiz deste repositório (era `ngen/` até o rebase).
