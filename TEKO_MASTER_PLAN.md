...
| 9 | SEC | 🔶 **PARTIAL** — C9.2 capability audit ✅ (`src/checker/capability_audit.md`); **C9.1 SAST gate** ✅ (`.github/workflows/sast.yml` — CodeQL + clang-tidy-audit, W6). Remaining: SEC hardening items (if any). | SAST + capability audit, after corrections |
